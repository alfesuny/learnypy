<?php
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $query = "DELETE FROM student_course WHERE student_email='$email' AND course_name='$course_name'
         AND course_instructor = '$course_instructor' AND course_category = '$course_category' ";
...
<body>
    ...
    <script>
        ...
        function redirectToCourses(categoryName) {
            window.location.href = 'enrolledcourses.php?category_name=' + encodeURIComponent(categoryName);
        }
    </script>
            ...
            <?php
                ...
                if ($link) {
                    ...
                    if(isset($_SESSION['user_type']) && $_SESSION['user_type'] == 'student'  && isset($_GET['category_name'])){
                        ...
                        INNER JOIN instructor_info ii
                        ON ci.course_instructor = ii.instructor_username
                        WHERE ci.course_category = '$category_name'";
                    }
                                    ...
                                    <div>
                                        <div>
                                            ...
                                            <h4 style="margin-top: 5px; margin-bottom: 5px;">
                                                <a href="./classroom.php?course_name=<?php echo$row['course_name']?>&course_category=<?php echo $row['course_category']?>&instructor_username=<?php echo $row['instructor_username']?>"><?= $row['course_name'] ?></a>
                                            </h4>
                                        ...
                                        <div style="margin-top: 15px;" class="courses__instructor">
                                            ...
                                            <?php if (isset($_SESSION['user_type']) && $_SESSION['user_type'] == 'student') { ?>
                                                <div>
                                                    <form method="POST" action="enrolledcourses.php">
